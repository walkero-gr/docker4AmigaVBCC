...
curl --retry 5 --retry-delay 2 --retry-connrefused -fsSL "http://server.owl.de/~frank/vbcc/2022-05-22/vbcc_target_ppc-amigaos.lha" -o vbcc_target_ppc-amigaos.lha || exit $?;
...
rm -rf vbcc_target_ppc-amigaos vbcc_target_ppc-amigaos.lha vbcc_unix_config.tar.gz config;
